...
import { generateDungeon, getTileBackgroundPosition } from '../utils/generateDungeon';
...
const DungeonMap = ({ width = 60, height = 60, minFloorTiles = 100 }) => {
    ...
    const getTileStyle = (tile) => {
        const backgroundImage = (tile.type === 'floor' || tile.type === 'corridor')
            ? 'url(/images/tilesets/light_cracked_stone.png)'
            : 'url(/images/tilesets/dark_stone_with_vines.png)';

        const backgroundPosition = getTileBackgroundPosition(tile.tileX, tile.tileY);
